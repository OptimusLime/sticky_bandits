...
# Generated by sticky_bandits - iOS COMPATIBLE
interface=$AP_IFACE
driver=nl80211

# Regulatory - CRITICAL FOR iOS
country_code=$COUNTRY
ieee80211d=1

# Basic 2.4GHz - maximum compatibility
ssid=$SSID
hw_mode=g
channel=$CHANNEL

# Disable 802.11n to maximize compatibility (can re-enable later)
ieee80211n=0

# WMM must be on for iOS
wmm_enabled=1

# Security - WPA2-PSK only (no WPA1, no TKIP)
auth_algs=1
wpa=2
